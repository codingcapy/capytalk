...
export default function MessageFriend(props) {
    ...
    return (
        <div className="py-2 message-container group hover:bg-slate-600 transition-all ease duration-300">
            ...
            <div className="flex"><div className="font-bold px-1">{props.message.username}</div><div className="pl-2">on {props.message.date.slice(0,10)} {props.message.date.slice(11,16)}</div></div>
